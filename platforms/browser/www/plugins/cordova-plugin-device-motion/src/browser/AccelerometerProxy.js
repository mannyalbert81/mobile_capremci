cordova.define("cordova-plugin-device-motion.AccelerometerProxy", function(require, exports, module) { cordova.define("cordova-plugin-device-motion.AccelerometerProxy", function(require, exports, module) { /*
 *
