cordova.define("cordova-plugin-device.DeviceProxy", function(require, exports, module) { cordova.define("cordova-plugin-device.DeviceProxy", function(require, exports, module) { /*
 *
